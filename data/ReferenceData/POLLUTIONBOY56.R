...
# clean
DistrictsAge45Older$pop_45o[DistrictsAge45Older$area_name == "Almora"] <- 160013

Clean45Older <- DistrictsAge45Older[-c(65), ]

Clean45Older <- Clean45Older %>%
  mutate(District = area_name,
         "45 or Older" = pop_45o) %>%
  dplyr::select(District, "45 or Older")
...
Clean45Older$District <- str_replace(Clean45Older$District, "Sabar Kantha", "Leh")
Clean45Older$District <- str_replace(Clean45Older$District, "LehLadakh", "Sabarkantha")




CensusDistricts2019 <- merge(CleanCensus2011, CleanDistricts, by=c("State","District"))
...
CensusDistricts2019 <- merge(CleanCensus2011, CleanDistricts, by=c("State","District")) %>%
  ...
  dplyr::select("District", "State", "Total Population", "Percent Male", "Percent Literate", "Percent Working", "Percent Rural", "Percent w/ No Education")
