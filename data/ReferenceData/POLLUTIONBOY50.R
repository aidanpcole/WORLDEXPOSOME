...
CensusDistricts2019 <- merge(CleanCensus2011, CleanDistricts, by = "District") %>%
  group_by(District) %>%
  summarise("Total Population" = sum(Population),
            "Total Males" = sum(Male),
            "Total Literate" = sum(Literate),
  ...
  mutate("Percent Male" = round((CensusDistricts2019$`Total Males`/CensusDistricts2019$`Total Population`) * 100, 2) ,
         ...
         "Percent Urban" = round((CensusDistricts2019$`Total Urban Households`/CensusDistricts2019$`Total Households`) * 100, 2),
         ...
         "Purchasing Power Quintile" = ntile(CensusDistricts2019$`Total Purchasing Power`,5)) %>%
