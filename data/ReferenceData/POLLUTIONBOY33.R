...
states2011 <- st_read("/Users/Aidan/Desktop/Raster-Timelapse/Raster-Timelapse/data/ReferenceData/PM25_2011_States.geojson") %>%
  dplyr::select(ST_NM,geometry,OBJECTID)
