...
AlphaCensus <- CleanCensus2011[order(CleanCensus2011$District),]
Alpha45Older <- Clean45Older[order(Clean45Older$District),]

CensusDistricts2019 <- merge(AlphaCensus, Alpha45Older, by="District")
