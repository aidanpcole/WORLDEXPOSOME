...
Census2011 <- read.csv("/Users/Aidan/Desktop/Raster-Timelapse/Raster-Timelapse/data/ReferenceData/india-districts-census-2011.csv") %>%
  ...
  dplyr::select("State","District",Population,Male,Literate,Workers,Households,Rural_Households,Urban_Households,Below_Primary_Education,Primary_Education,Middle_Education,Secondary_Education,Higher_Education,Graduate_Education,Other_Education,Total_Education,Total_Power_Parity) 
...
CompleteCensusStates2019 <- merge(CensusStates2019, CleanStates2019 %>%
...
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Andhra Pradesh"] <- 11885501
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Arunachal Pradesh"] <- 203314
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Assam"] <- 5722981
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Bihar"] <- 18086937
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Chandigarh"] <- 209297
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Andhra Pradesh"] <- 11885501
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Andhra Pradesh"] <- 11885501
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Andhra Pradesh"] <- 11885501
CleanCensus2011$`45 or Older`[CleanCensus2011$State == "Andhra Pradesh"] <- 11885501
...
st_write(CompleteCensusStates2019, "/Users/Aidan/Desktop/Raster-Timelapse/Raster-Timelapse/data/DataForMap/censusstates2011.geojson")
