...
states2019 <- st_read("/Users/Aidan/Desktop/Raster-Timelapse/Raster-Timelapse/data/ReferenceData/PM25_2019_States.geojson") %>%
  ...
  dplyr::select(OBJECTID, State,"2019 PM 2.5 Score","Total Area (km^2)", geometry)
...
Census2011 <- read.csv("/Users/Aidan/Desktop/Raster-Timelapse/Raster-Timelapse/data/ReferenceData/india-districts-census-2011.csv") %>%
  ...
  dplyr::select("State","District",Population,Male,Literate,Workers,Households,Rural_Households,Urban_Households,Below_Primary_Education,Primary_Education,Middle_Education,Secondary_Education,Higher_Education,Graduate_Education,Other_Education,Total_Education,Age_Group_0_29,Age_Group_30_49,Age_Group_50,Total_Power_Parity) 
