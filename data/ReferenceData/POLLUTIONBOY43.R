...
CensusStates2019 <- merge(CleanCensus2011, CleanStates2019, by = "State") %>%
  group_by(State) %>%
  ...
  mutate("Percent Male" = round((CensusStates2019$`Total Males`/CensusStates2019$`Total Population`) * 100, 2) ,
         ...
         "Percent Over 50" = round((CensusStates2019$`Total 50 Years or Older`/CensusStates2019$`Total Population`) * 100, 2),
         "Purchasing Power Quintile" = ntile(CensusStates2019$`Total Purchasing Power`,5),
         "2019 PM 2.5 Quintile" = ntile(CensusStates2019$`2019 PM 2.5 Score`,5)) %>%
  dplyr::select("State", "Total Population", "Percent Male", "Percent Literate", "Percent Working", "Percent Rural", "Percent w/ No Education", "Percent Over 50", "2019 PM 2.5 Quintile")
