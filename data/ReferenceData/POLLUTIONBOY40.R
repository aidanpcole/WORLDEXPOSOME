...
CensusStates2011 <- merge(CleanCensus2011, StatesandUTs2011, by = "State") %>%
  ...
  mutate("Percent Male" = CensusStates2011$`Total Males`/CensusStates2011$`Total Population`,
         "Percent Literate" = CensusStates2011$`Total Literate`/CensusStates2011$`Total Population`,
         "Percent Working" = CensusStates2011$`Total Workers`/CensusStates2011$`Total Population`,
         "Percent w/ Internet" = CensusStates2011$`Total Households with Internet`/CensusStates2011$`Total Households`,
         "Percent w/ Computer" = CensusStates2011$`Total Households with Computer`/CensusStates2011$`Total Households`,
         "Percent Rural" = CensusStates2011$`Total Rural Households`/CensusStates2011$`Total Households`,
         "Percent Urban" = CensusStates2011$`Total Urban Households`/CensusStates2011$`Total Households`,
         "Percent w/ Higher Ed" = (CensusStates2011$`Total with Higher Education` + CensusStates2011$`Total with Graduate Education`)/CensusStates2011$`Total with Education`,
         "Percent Over 50" = CensusStates2011$`Total 50 Years or Older`/CensusStates2011$`Total Population`,
         "Percent w/ Transportation" = CensusStates2011$`Total Households with Transportation`/CensusStates2011$`Total Households`,
         "Percent w/ Phone" = CensusStates2011$`Total Households with Phone`/CensusStates2011$`Total Households`,
         "Percent w/ TV" = CensusStates2011$`Total Households with Television`/CensusStates2011$`Total Households`,
         "Percent Owned Households" = CensusStates2011$`Total Households Owned`/CensusStates2011$`Total Households`,
         "Percent Rented Households" = CensusStates2011$`Total Households Rented`/CensusStates2011$`Total Households`,
         "Percent 1-5 Person Households" = CensusStates2011$`Total Households with 1-5 People`/CensusStates2011$`Total Households`,
         "Percent >6 Person Households" = CensusStates2011$`Total Households with >6 People`/CensusStates2011$`Total Households`,
         "Purchasing Power Quintile" = ntile(CensusStates2011$`Total Purchasing Power`,5)) %>%
  dplyr::select("State", "Total Population", "Total Households", "Percent Male", "Percent Literate", "Percent Working", "Percent Urban", "Percent w/ Higher Ed", "Percent Over 50", "Purchasing Power Quintile")
