...
CleanCensus2011$District <- str_replace(CleanCensus2011$District, "Leh(Ladakh)", "Leh")
...
shapename <- read_sf('/Users/Aidan/Downloads/maps-master/maps-master/Districts/Census_2011/2011_Dist.shp')
shape <- read_sf(dsn = "/Users/Aidan/Downloads/maps-master/maps-master/Districts/Census_2011/2011_Dist.shp", layer = "SHAPEFILE")

x <- unique(shapename$DISTRICT)

y <- unique(Census2011$District)
